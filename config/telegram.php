...
return [
    ...
    */
    'bots'                         => [
        'mybot' => [
            'username'            => 'MyBot',
            'token'               => env('TELEGRAM_BOT_TOKEN', '2101823790:AAGM2r0PB0Dpy6Nwwzl_SguFVNUjrfgOTew'),
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'https://webhook.site/fe0bff49-47ec-41d4-a269-4f4857e58af2'),
            'commands'            => [
